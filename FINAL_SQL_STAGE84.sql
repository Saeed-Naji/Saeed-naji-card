-- ============================================================================
-- FINAL CONSOLIDATED SUPABASE SQL — STAGE84
...
-- FINAL SUPABASE MASTER SQL — STAGE84
...
select id, require_customer_lead, updated_at
from public.site_settings
where id=1;

-- ###########################################################################
-- STAGE84 ADMIN=2 FINAL PERMISSION HARDENING
...
select 'STAGE84_ADMIN2_PERMISSIONS_OK' as status;
select 'STAGE84_FINAL_OK' as status;
